        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {state.succeeded ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-600">
                    ...
                    contato em breve para agendar nossa conversa.
                </p>
              </div>
            ) : (
              <>
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                  ...
                  >
                    {state.submitting ? 'Enviando...' : 'QUERO MEU DIAGNÓSTICO GRATUITO'}
                  </button>
                </form>
              </>
            )}
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100 space-y-8">
            <div>
                ...
                <p className="text-gray-500 text-sm">Prefere um contato direto? Escolha um dos canais abaixo:</p>
            </div>
